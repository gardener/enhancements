...
![alt text](CurrentClusterVPN.png "Overview Current Cluster VPN")
...
![alt text](ReversedTunnelVPN.png "Reversed Tunnel VPN")
...
The `vpn-shoot-client` pod connects to the correct `vpn-seed-server` service via the SNI passthrough proxy introduced with [SNI Passthrough proxy for kube-apiservers](../0008-shoot-apiserver-via-sni/README.md) on port 8132.
...
![alt text](WireGuardClusterVPN.png "Overview WireGuard Current Cluster VPN")
