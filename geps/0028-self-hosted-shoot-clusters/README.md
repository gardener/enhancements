...
<img src="https://github.com/gardener/gardener/tree/master/logo/gardenadm-large.png" alt="gardenadm" width="100"/>
...
2. Generate [`OperatingSystemConfig` resource](https://github.com/gardener/gardener/tree/master/docs/extensions/resources/operatingsystemconfig.md) (in memory) containing `systemd` units and files.
...
3. Reconcile the `OperatingSystemConfig` resource using the controller logic of [`gardener-node-agent`](https://github.com/gardener/gardener/tree/master/docs/concepts/node-agent.md).
...
5. Deploy [`gardener-resource-manager`](https://github.com/gardener/gardener/tree/master/docs/concepts/resource-manager.md) in [host network mode](#host-network-vs-pod-network) into the `kube-system` namespace.
...
8. Create a [`Network` resource](https://github.com/gardener/gardener/tree/master/docs/extensions/resources/network.md) and apply it to generate `ManagedResource` associated with the pod network.
...
11. Create the [`OperatingSystemConfig` resource](https://github.com/gardener/gardener/tree/master/docs/extensions/resources/operatingsystemconfig.md) now in the cluster and activate the `gardener-node-agent` process via its `systemd` unit.
12. Apply [`ControlPlane` resource](https://github.com/gardener/gardener/tree/master/docs/extensions/resources/controlplane.md).
